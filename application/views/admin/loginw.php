...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Facility Services| Log in</title>
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <link rel="shortcut icon" href="assets/img/LOGHEAD1.png" type="image/x-icon">
        <!-- Bootstrap 3.3.2 -->
 ...
 echo "<style>
    body{
        background-image:url(".base_url()."assets/img/beckround/bglog1.png);
    ...
    <body >
        <div class="login-box">
            <div class="login-logo">
                <small>
                            <img src="assets/img/iss.png" alt="" />
                        </small>

                <a href="" > <b class= "text-gray"> Facility</b> <i class="text-blue">Services </i></a>
            </div><!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg" style='color : blue'>Silahkan Masukan Username & Password Anda </p>
                   ...
                   <div><?php 
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="cform-group has-feedback">
                            <button type="submit" class="btn bg-purple btn-block btn-flat"><i class="fa fa-sign-in"></i> Sign In</button>
                        </div>
                </form>                
            ...
            <b class="text-blue">
             Copyright &copy; <script>document.write(new Date().getFullYear());</script> <strong>ISS INDO System Selection</strong>All Rights Reserved
  </div>
        </div><!-- /.login-box -->
