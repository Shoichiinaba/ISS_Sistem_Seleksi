<div class="content-wrapper">
        ...
        <h1>
          Karyawan Sudah
          <small>TTD Pemutusan Kontrak </small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo site_url('dashboard'); ?>"><i class="fa fa-dashboard"></i> Home > End Kontrak</a></li>
        </ol>
        </section>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped" >
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                    <?php if($g->kirim==3){
                                                    echo "<span class='label label-warning'> Sudah TTD End Kontrak</span>";
                                    ...
                                    <td>
                                    <?php if($g->kirim==1){
                                                    echo "<span class='label label-succsess'> Sudah TTD Kontrak</span>";
                                                    //$teks="Nonaktifkan Data";
                                                    $icon="switch";
                                                    $class="purple";
                                            }elseif($g->kirim==3){
                                          ...
                                          <div class="box box-warning">
                                            ...
                                            <div class="box-body">
                                              <a href="<?= base_url('Kontrak_lap/laporanHR/');?>" target="_blank"> 
                                                <button type="button" class="btn bg-blue-gradient margin">
                                                <i  class="glyphicon glyphicon-print"></i>&nbsp; Cetak
                                                </button>
                                              </a>
                                              <button type="submit" class="btn bg-yellow-gradient" name="hapus">
                                              <i class="fa fa-trash-o"> Hapus</i>
                                              </button>
                                              <a href="<?= base_url('New_kontrak/');?>"> 
                                                <button type="button" class="btn bg-maroon-gradient margin">
