...
<header class="main-header">
    ...
    <a href="<?php echo site_url(''); ?>" class="logo">
      <span class="logo-mini"><small>
                            <img width="50%" height="50%" src="<?php echo base_url(); ?>assets/img/LOGHEAD1.png">
                        </small>
      </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">
        <b>ISS</b> Selection</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header" style="background: url('assets/img/beckround/bekr.jpg') center;">
